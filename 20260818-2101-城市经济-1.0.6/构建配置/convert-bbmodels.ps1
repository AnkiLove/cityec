...
function Convert-BbModel {
    ...
    if ($OpaqueBottom) {
        $textures['bottom'] = 'cityec:block/cash_register_bottom'
    }
...
$bottomTexture = [System.Drawing.Bitmap]::new(16, 16)
$bottomColor = [System.Drawing.Color]::FromArgb(255, 184, 189, 190)
for ($x = 0; $x -lt 16; $x++) {
    for ($y = 0; $y -lt 16; $y++) { $bottomTexture.SetPixel($x, $y, $bottomColor) }
}
$bottomTexture.Save((Join-Path $ProjectRoot 'src/main/resources/assets/cityec/textures/block/cash_register_bottom.png'), [System.Drawing.Imaging.ImageFormat]::Png)
